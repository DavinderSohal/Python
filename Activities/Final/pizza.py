...
class Pizza:
    ...
    def setSize(self):
        ...
        while not (self.size == "s" or self.size == "m" or self.size == "l"):
    ...
    def iceCost(self):
        totalCost = sum(self.get_cost) + sum(
        ...
        if len(self.get_ice_cream_cost) == 0:
            ...
            print(f"Total amount with icecream(s) is ${totalCost}")  # print the ice cream cost
