...
class Pizza:
    ...
    def pizzasOfSize(self, details):
        ...
        if self.details not in self.get_size:
            ...
            if self.ice == 'y':
                for h in range(1, len(self.get_ice_cream) + 1):
                    print(f"Ice cream : {h}. {self.get_ice_cream[x]}")
        ...
        while True:
            ...
            if choice == 1:
                ...
                if feedback_choice == 'y':
                    feedback = input("\nPlease give here : ")
                    print("Thanks for your valuable words")
